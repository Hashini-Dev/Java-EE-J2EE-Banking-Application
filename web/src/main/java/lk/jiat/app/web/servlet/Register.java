...
public class Register extends HttpServlet {
        ...
        protected void doPost(HttpServletRequest request, HttpServletResponse response)
                ...
                if (!password.matches(passwordPattern)) {
                        response.sendRedirect(request.getContextPath() + "/register.jsp?error=invalid_password");
                        return;
                }
                ...
                try {
                        ...
                        response.sendRedirect(request.getContextPath() + "/register.jsp?error=already_exists&message="
