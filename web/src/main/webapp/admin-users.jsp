...
<head>
    ...
    <title>User Management | Wealth Bank</title>
            ...
            <div class="col-lg-3">
                <div class="glass-card p-4 animate">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active px-2 mb-2" href="${pageContext.request.contextPath}/admin/users">
                            <svg class="me-2" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="col-lg-9">
                <div class="glass-card p-4 animate">
                    ...
                    <% if (request.getParameter("error") != null) { %>
                        <div class="alert alert-danger text-center mb-4" role="alert" style="background-color: #f8d7da; color: #842029;">
                            <%
                                ...
                                if ("has_accounts".equals(error)) {
                                    out.print("Error: Cannot delete user. They still have active bank accounts.");
                                } else if ("cannot_delete_self".equals(error)) {
                                    out.print("Error: You cannot delete your own admin account.");
                                } else {
                                    out.print("An error occurred processing the user.");
                                }
                            %>
                        </div>
                    <% } %>
                        ...
                        <div class="alert alert-success text-center mb-4" role="alert">
                            <%
                                ...
                                if ("deleted".equals(success)) {
                                    out.print("User account successfully deleted.");
                                }
                            %>
                        </div>
                    <% } %>
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="${pageContext.request.contextPath}/register.jsp" class="btn btn-outline-primary me-2">Register Customer</a>
                        <a href="${pageContext.request.contextPath}/admin-register.jsp" class="btn btn-supiri text-white">Register Admin</a>
                    </div>
                            ...
                            <tbody>
                                <c:forEach var="u" items="${usersList}">
                                    <tr>
                                        ...
                                        <td>${u.email}</td>
                                        <td>
                                            <span class="badge <c:choose><c:when test="${u.userType.type == 'Admin'}">bg-danger</c:when><c:otherwise>bg-primary</c:otherwise></c:choose>">
                                                ${u.userType.type}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            ...
                                            <form action="${pageContext.request.contextPath}/admin/user/delete" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-danger px-3">Deactive</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
