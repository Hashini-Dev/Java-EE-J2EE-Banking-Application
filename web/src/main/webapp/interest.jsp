            ...
            <div class="row g-4">
                    ...
                    <div class="glass-card p-5 animate">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-0">Monitor and manually trigger automated EJB background tasks.
                                    This section is restricted to administrative personnel and utilizes @RolesAllowed
                                    security.</p>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="glass-card p-4 h-100 animate delay-1">
                        ...
                        <p class="text-muted small mb-4">Triggers the calculation and application of interest rates
                            ...
                            <strong>InterestCalculationService</strong> EJB bean.</p>
                        ...
                        <form action="triggerInterest" method="POST">
                            <button type="submit" class="btn btn-supiri w-100 py-3">Run Interest Calculation
                                Now</button>
                            <p class="text-center small text-muted mt-2">Requires ADMIN privileges for manual execution.
                            </p>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="glass-card p-4 h-100 animate delay-1">
                        ...
                        <p class="text-muted small mb-4">Executes batch processing for approved loan disbursements. Uses
                            <strong>UserTransaction</strong> (BMT) to ensure all deposits succeed or all fail.</p>

                        <div class="alert alert-info border-0 rounded-4 small py-3">
                            <strong>Note:</strong> Transaction demarcation ensures data integrity even if hardware fails
                            during processing.
                        </div>
                        ...
                        <form action="triggerBatch" method="POST">
                            <button type="submit" class="btn btn-outline-supiri w-100 py-3">Trigger Batch
                                Disbursement</button>
                            <p class="text-center small text-muted mt-2">Protected by JTA Global Transaction Management.
                            </p>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="glass-card p-4 animate delay-2">
                        ...
                        <div class="bg-dark rounded-4 p-4 font-monospace overflow-auto"
                            ...
                            <div>[INFO] 2024-02-12 14:00:05 - LoggingInterceptor: Exiting method:
                                InterestCalculationService.scheduledInterestCalculation (Execution Time: 4500ms)</div>
